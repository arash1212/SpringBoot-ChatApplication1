...
public class UserAuthorityController {
    ...
    public ResponseEntity<List<UserAuthorityOutput>> getAll() {
    ...
    public ResponseEntity<Long> save(@Valid @RequestBody UserAuthorityInput input) {
    ...
    public ResponseEntity<UserAuthorityOutput> update(@PathVariable(name = "id") Long id, @Valid @RequestBody UserAuthorityInput input) {
