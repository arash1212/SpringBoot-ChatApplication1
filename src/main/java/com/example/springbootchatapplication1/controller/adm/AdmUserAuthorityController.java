...
public class AdmUserAuthorityController {
    ...
    public ResponseEntity<Long> save(@Valid @RequestBody UserAuthorityInput input, @AuthenticationPrincipal Authentication authentication) {
    ...
    public void delete(@PathVariable(name = "id") Long id, @AuthenticationPrincipal Authentication authentication) {
